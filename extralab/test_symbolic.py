...
tests("show_exp_infix(0,add(sub(var(),const(3)),const(2)))","x - 3 + 2")
tests("show_exp_infix(0,sub(var(),add(const(3),const(2))))","x - (3 + 2)")
tests("show_exp_infix(0,mul(add(var(),const(3)),const(2)))","(x + 3) * 2")
tests("show_exp_infix(0,add(var(),mul(const(3),const(2))))","x + 3 * 2")
tests("show_exp_infix(0,mul(div(var(),const(3)),const(2)))","x / 3 * 2")
tests("show_exp_infix(0,div(var(),mul(const(3),const(2))))","x / (3 * 2)")
tests("show_exp_infix(0,pow(mul(var(),const(3)),const(2)))","(x * 3) ^ 2")
tests("show_exp_infix(0,mul(var(),pow(const(3),const(2))))","x * 3 ^ 2")
